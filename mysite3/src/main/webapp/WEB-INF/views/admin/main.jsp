			...
			<div id="content">
				<div id="site-form">
					<form method="post" action="${pageContext.request.contextPath }/admin/main/update" enctype="multipart/form-data">
						...
						<input id="title" name="title" type="text" value="${sitevo.title }" required>
						
						<label class="block-label" for="welcome">환영 메세지</label>
						<input id="welcomeMessage" name="welcome" type="text" value="${sitevo.welcome }" required>
						...
						<textarea name="description" required>${sitevo.description }</textarea>
